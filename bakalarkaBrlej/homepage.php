...
<div class="container" style="margin-top: 20px">
    <h3 style="text-align: center">Vypln nase otazky prosim.</h3>
    <div style="text-align: center; font-weight: bold;">
        <p><?php if(isset($message)){echo $message;} ?></p>
    </div>
    <form id="questionForm" action="questions.php" method="post" name="questionForm">
        ...
        <div class="container">
            <div class="col-sm-10">
                <button type="submit" class="btn btn-primary" id="sumbitSubject" name="sumbitSubject">Proceed</button>
            </div>
        </div>
    </form>
</div>
