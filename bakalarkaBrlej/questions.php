...
$query = $con->prepare("SELECT question_number, question, question_image FROM questions WHERE subject = ?");
...
<div class="container" style="margin-top: 20px;">
    ...
    <form id="quizForm" method="post" action="handlers/test_handler.php" name="testForm">
        ...
        <div class="container">
            <div class="col-sm-10">
                <button type="submit" class="btn btn-primary" id="submitTest" name="submitTest">Submit Test</button>
            </div>
        </div>
    </form>
</div>
